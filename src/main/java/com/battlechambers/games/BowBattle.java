...
/**
 * Bow Battle Mini-Game
 * Players fight each other using only bows
 * Last player standing wins!
 */
public class BowBattle extends AbstractMiniGame {

    public BowBattle() {
        super("bow-battle", "Bow Battle", "Fight with bows!", 2, 24, 120);
    }
